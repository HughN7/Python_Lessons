...
# Turtle "Animations"
We can make "animations" in various ways. We're gonna focus on using timed delays
...
time.sleep(1) # Wait before clearing the background
screen.bgcolor("white")
time.sleep(1) # Wait before setting the background
screen.bgcolor(color)
time.sleep(1) # Wait before clearing the background
screen.bgcolor("white")
time.sleep(1) # Wait before setting the background
